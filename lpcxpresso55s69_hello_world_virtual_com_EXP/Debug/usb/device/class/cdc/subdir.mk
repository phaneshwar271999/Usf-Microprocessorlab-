...
usb/device/class/cdc/%.o: ../usb/device/class/cdc/%.c usb/device/class/cdc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-usb-2f-device-2f-class-2f-cdc

clean-usb-2f-device-2f-class-2f-cdc:
	-$(RM) ./usb/device/class/cdc/usb_device_cdc_acm.d ./usb/device/class/cdc/usb_device_cdc_acm.o

.PHONY: clean-usb-2f-device-2f-class-2f-cdc
