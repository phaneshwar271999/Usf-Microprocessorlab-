...
sdmmc/src/%.o: ../sdmmc/src/%.c sdmmc/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-sdmmc-2f-src

clean-sdmmc-2f-src:
	-$(RM) ./sdmmc/src/fsl_sd.d ./sdmmc/src/fsl_sd.o ./sdmmc/src/fsl_sdmmc_common.d ./sdmmc/src/fsl_sdmmc_common.o

.PHONY: clean-sdmmc-2f-src
